...
// I paired Tom McHenry on this challenge.
...
/*  What JavaScript knowledge did you solidify in this challenge?
    ...
    I am still very new to JavaScript so I solidified a lot of knowledge with 
    this challenge such as basic syntax, iterating over arrays, dealing with 
    different data types, and constructor functions. 

    What are constructor functions?

    Constructor functions are a way to define a method as well as certain 
    properties for the function. With this type of function, we use "this" 
    syntax to define properties, and this differs from literal function 
    declarations.

    How are constructors different from Ruby classes (in your research)?

    In terms of what they can achieve they seem quite similar, so the main 
    differences seem to be in syntax. Constructors don't need an explicit 
    initializer like Ruby classes, we simply define new properties within the 
    constructor. Also, we have functions within functions for Javascript 
    fairly often, while with Ruby we have not put classes inside classes yet.
